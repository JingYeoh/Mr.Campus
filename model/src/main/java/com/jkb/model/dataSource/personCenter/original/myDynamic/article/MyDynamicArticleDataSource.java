package com.jkb.model.dataSource.personCenter.original.myDynamic.article;
...
public interface MyDynamicArticleDataSource {
     ...
     */
    void getMyDynamicArticle(String Authorization, @NonNull int user_id, @NonNull int page,
