package com.jkb.model.dataSource.dynamicDetail.topic.remote;
...
import com.jkb.model.dataSource.dynamicDetail.topic.DynamicDetailTopicDataSource;
...
public class DynamicDetailTopicRemoteDataSource implements DynamicDetailTopicDataSource {


    private DynamicDetailTopicRemoteDataSource() {
    }

    private static DynamicDetailTopicRemoteDataSource INSTANCE = null;

    public static DynamicDetailTopicRemoteDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new DynamicDetailTopicRemoteDataSource();
        }
        return INSTANCE;
    }
    ...
    public void getTopicDynamic(
        ...
        Call<ApiResponse<DynamicTopicEntity>> call;
        call = dynamicApi.getTopicDynamic(user_id, dynamic_id);
        Type type = new TypeToken<ApiResponse<DynamicTopicEntity>>() {
        }.getType();
        new ApiEngine<ApiResponse<DynamicTopicEntity>>(apiCallback, call, type);
    }
