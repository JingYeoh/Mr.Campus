package com.jkb.model.dataSource.dynamicCreate.topic.local;
...
public class DynamicCreateTopicLocalDataSource implements DynamicCreateTopicDataSource {


    private Context applicationContext;

    public DynamicCreateTopicLocalDataSource(Context applicationContext) {
        this.applicationContext = applicationContext;
    }

    private static DynamicCreateTopicLocalDataSource INSTANCE = null;

    public static DynamicCreateTopicLocalDataSource getInstance(@NonNull Context applicationContext) {
        if (INSTANCE == null) {
            INSTANCE = new DynamicCreateTopicLocalDataSource(applicationContext);
        }
        return INSTANCE;
    }
