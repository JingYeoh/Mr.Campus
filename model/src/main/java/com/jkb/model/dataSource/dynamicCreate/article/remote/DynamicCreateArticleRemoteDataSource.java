package com.jkb.model.dataSource.dynamicCreate.article.remote;
...
public class DynamicCreateArticleRemoteDataSource implements DynamicCreateArticleDataSource {

    private DynamicCreateArticleRemoteDataSource() {
    }

    private static DynamicCreateArticleRemoteDataSource INSTANCE = null;

    public static DynamicCreateArticleRemoteDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new DynamicCreateArticleRemoteDataSource();
        }
        return INSTANCE;
    }
