package com.jkb.model.dataSource.dynamicCreate.normal.remote;
...
public class DynamicCreateNormalRemoteDataSource implements DynamicCreateNormalDataSource {

    private DynamicCreateNormalRemoteDataSource() {
    }

    private static DynamicCreateNormalRemoteDataSource INSTANCE = null;

    public static DynamicCreateNormalRemoteDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new DynamicCreateNormalRemoteDataSource();
        }
        return INSTANCE;
    }
