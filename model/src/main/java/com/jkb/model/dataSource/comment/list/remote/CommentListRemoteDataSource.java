package com.jkb.model.dataSource.comment.list.remote;
...
public class CommentListRemoteDataSource implements CommentListDataSource {

    private CommentListRemoteDataSource() {
    }

    private static CommentListRemoteDataSource INSTANCE = null;

    public static CommentListRemoteDataSource genInstance() {
        if (INSTANCE == null) {
            INSTANCE = new CommentListRemoteDataSource();
        }
        return INSTANCE;
    }
