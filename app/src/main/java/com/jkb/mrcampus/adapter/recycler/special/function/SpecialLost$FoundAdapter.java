...
public class SpecialLost$FoundAdapter extends
        RecyclerView.Adapter<SpecialLost$FoundAdapter.ViewHolder> implements View.OnClickListener {

    private Context context;
    public List<SpecialData> specialData;
    private OnSpecialConfessionItemClickListener onSpecialConfessionItemClickListener;

    public SpecialLost$FoundAdapter(Context context, List<SpecialData> specialData) {
