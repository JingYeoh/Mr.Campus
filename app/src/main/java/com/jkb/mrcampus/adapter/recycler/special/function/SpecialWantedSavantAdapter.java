...
public class SpecialWantedSavantAdapter extends
        RecyclerView.Adapter<SpecialWantedSavantAdapter.ViewHolder> implements View.OnClickListener {

    private Context context;
    public List<SpecialData> specialData;
    private OnSpecialConfessionItemClickListener onSpecialConfessionItemClickListener;

    public SpecialWantedSavantAdapter(Context context, List<SpecialData> specialData) {
