...
public class SpecialWantedPartnerAdapter extends
        RecyclerView.Adapter<SpecialWantedPartnerAdapter.ViewHolder> implements View.OnClickListener {

    private Context context;
    public List<SpecialData> specialData;
    private OnSpecialConfessionItemClickListener onSpecialConfessionItemClickListener;

    public SpecialWantedPartnerAdapter(Context context, List<SpecialData> specialData) {
