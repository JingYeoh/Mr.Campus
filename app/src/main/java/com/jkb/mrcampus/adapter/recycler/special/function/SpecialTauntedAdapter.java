...
public class SpecialTauntedAdapter extends
        RecyclerView.Adapter<SpecialTauntedAdapter.ViewHolder> implements View.OnClickListener {

    private Context context;
    public List<SpecialData> specialData;
    private OnSpecialConfessionItemClickListener onSpecialConfessionItemClickListener;

    public SpecialTauntedAdapter(Context context, List<SpecialData> specialData) {
