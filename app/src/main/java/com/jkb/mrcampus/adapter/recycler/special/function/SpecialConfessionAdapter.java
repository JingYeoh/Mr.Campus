...
public class SpecialConfessionAdapter extends
        RecyclerView.Adapter<SpecialConfessionAdapter.ViewHolder> implements View.OnClickListener {

    private Context context;
    public List<SpecialData> specialData;
    private OnSpecialConfessionItemClickListener onSpecialConfessionItemClickListener;

    public SpecialConfessionAdapter(Context context, List<SpecialData> specialData) {
