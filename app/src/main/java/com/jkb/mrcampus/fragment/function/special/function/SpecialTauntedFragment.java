...
import com.jkb.core.contract.function.special.function.SpecialTauntedContract;
import com.jkb.core.data.special.SpecialData;
import com.jkb.core.presenter.function.special.function.SpecialTauntedPresenter;
import com.jkb.model.info.SchoolInfoSingleton;
import com.jkb.mrcampus.R;
import com.jkb.mrcampus.activity.MainActivity;
import com.jkb.mrcampus.adapter.recycler.special.function.SpecialTauntedAdapter;
...
public class SpecialTauntedFragment extends BaseFragment implements
        SpecialTauntedContract.View, SwipeRefreshLayout.OnRefreshListener,
    ...
    private SpecialTauntedContract.Presenter mPresenter;

    //列表
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private SpecialTauntedAdapter specialTauntedAdapter;
    ...
    protected void initListener() {
        ...
        specialTauntedAdapter.setOnSpecialConfessionItemClickListener(
    ...
    protected void initData(Bundle savedInstanceState) {
        //绑定P层
        mPresenter = new SpecialTauntedPresenter(this,
                Injection.provideSpecialRepertory(mActivity.getApplicationContext()));

        specialTauntedAdapter = new SpecialTauntedAdapter(context, null);
        recyclerView.setAdapter(specialTauntedAdapter);
    }
    ...
    public void setSpecialData(List<SpecialData> specialData) {
        specialTauntedAdapter.specialData = specialData;
        specialTauntedAdapter.notifyDataSetChanged();
    }

    @Override
    public void startSpecialTauntedDetail(int dynamicId) {
        mainActivity.startSpecialDetailTaunted(dynamicId);
    }
     ...
     * 表白墙的条目点击事件监听
     */
    private SpecialTauntedAdapter.OnSpecialConfessionItemClickListener
            onSpecialConfessionItemClickListener =
            new SpecialTauntedAdapter.OnSpecialConfessionItemClickListener() {
                @Override
