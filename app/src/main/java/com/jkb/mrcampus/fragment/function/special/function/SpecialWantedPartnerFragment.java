...
import com.jkb.core.contract.function.special.function.SpecialWantedPartnerContract;
import com.jkb.core.data.special.SpecialData;
import com.jkb.core.presenter.function.special.function.SpecialWantedPartnerPresenter;
import com.jkb.model.info.SchoolInfoSingleton;
import com.jkb.mrcampus.R;
import com.jkb.mrcampus.activity.MainActivity;
import com.jkb.mrcampus.adapter.recycler.special.function.SpecialWantedPartnerAdapter;
...
public class SpecialWantedPartnerFragment extends BaseFragment implements
        SpecialWantedPartnerContract.View, SwipeRefreshLayout.OnRefreshListener,
        Observer, View.OnClickListener {

    public static SpecialWantedPartnerFragment newInstance() {
        Bundle args = new Bundle();
        SpecialWantedPartnerFragment fragment = new SpecialWantedPartnerFragment();
    ...
    private SpecialWantedPartnerContract.Presenter mPresenter;

    //列表
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private SpecialWantedPartnerAdapter specialWantedPartnerAdapter;
    ...
    protected void initListener() {
        ...
        specialWantedPartnerAdapter.setOnSpecialConfessionItemClickListener(
    ...
    protected void initData(Bundle savedInstanceState) {
        //绑定P层
        mPresenter = new SpecialWantedPartnerPresenter(this,
                Injection.provideSpecialRepertory(mActivity.getApplicationContext()));

        specialWantedPartnerAdapter = new SpecialWantedPartnerAdapter(context, null);
        recyclerView.setAdapter(specialWantedPartnerAdapter);
    }
    ...
    public void setSpecialData(List<SpecialData> specialData) {
        specialWantedPartnerAdapter.specialData = specialData;
        specialWantedPartnerAdapter.notifyDataSetChanged();
    }

    @Override
    public void startSpecialWantedPartnerDetail(int dynamicId) {
        mainActivity.startSpecialDetailWantedPartner(dynamicId);
    }
    ...
    @Override
    public void setPresenter(SpecialWantedPartnerContract.Presenter presenter) {
     ...
     * 表白墙的条目点击事件监听
     */
    private SpecialWantedPartnerAdapter.OnSpecialConfessionItemClickListener
            onSpecialConfessionItemClickListener =
            new SpecialWantedPartnerAdapter.OnSpecialConfessionItemClickListener() {
                @Override
