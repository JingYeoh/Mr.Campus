...
public class SearchDetailDynamicFragment extends BaseFragment implements
        SearchDetailContract.View, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {

    public static SearchDetailDynamicFragment newInstance() {
        Bundle args = new Bundle();
        SearchDetailDynamicFragment fragment = new SearchDetailDynamicFragment();
    ...
    public View onCreateView(
        ...
        setRootView(R.layout.frg_search_detail_dynamic);
    ...
    public void onResume() {
        super.onResume();
        mPresenter.setSearchType(SearchDetailContract.Presenter.SEARCH_TYPE_DYNAMIC);
        mPresenter.start();
    }
