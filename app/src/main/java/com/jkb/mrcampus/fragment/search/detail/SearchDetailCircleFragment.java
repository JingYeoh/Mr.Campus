...
public class SearchDetailCircleFragment extends BaseFragment implements
        SearchDetailContract.View, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {

    public static SearchDetailCircleFragment newInstance() {
        Bundle args = new Bundle();
        SearchDetailCircleFragment fragment = new SearchDetailCircleFragment();
    ...
    public View onCreateView(
        ...
        setRootView(R.layout.frg_search_detail_circle);
    ...
    public void onResume() {
        super.onResume();
        mPresenter.setSearchType(SearchDetailContract.Presenter.SEARCH_TYPE_CIRCLE);
        mPresenter.start();
    }
