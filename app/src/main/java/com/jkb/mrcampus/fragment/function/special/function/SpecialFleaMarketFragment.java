...
import com.jkb.core.contract.function.special.function.SpecialFleaMarketContract;
import com.jkb.core.data.special.SpecialData;
import com.jkb.core.presenter.function.special.function.SpecialFleaMarketPresenter;
import com.jkb.model.info.SchoolInfoSingleton;
import com.jkb.mrcampus.R;
import com.jkb.mrcampus.activity.MainActivity;
import com.jkb.mrcampus.adapter.recycler.special.function.SpecialFleaMarketAdapter;
...
public class SpecialFleaMarketFragment extends BaseFragment implements
        SpecialFleaMarketContract.View, SwipeRefreshLayout.OnRefreshListener,
        Observer, View.OnClickListener {

    public static SpecialFleaMarketFragment newInstance() {
        Bundle args = new Bundle();
        SpecialFleaMarketFragment fragment = new SpecialFleaMarketFragment();
    ...
    private SpecialFleaMarketContract.Presenter mPresenter;

    //列表
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private SpecialFleaMarketAdapter specialFleaMarketAdapter;
    ...
    protected void initListener() {
        ...
        specialFleaMarketAdapter.setOnSpecialConfessionItemClickListener(
    ...
    protected void initData(Bundle savedInstanceState) {
        //绑定P层
        mPresenter = new SpecialFleaMarketPresenter(this,
                Injection.provideSpecialRepertory(mActivity.getApplicationContext()));

        specialFleaMarketAdapter = new SpecialFleaMarketAdapter(context, null);
        recyclerView.setAdapter(specialFleaMarketAdapter);
    }
    ...
    public void setSpecialData(List<SpecialData> specialData) {
        specialFleaMarketAdapter.specialData = specialData;
        specialFleaMarketAdapter.notifyDataSetChanged();
    }

    @Override
    public void startSpecialFleaMarketDetail(int dynamicId) {
        mainActivity.startSpecialDetailFleaMarket(dynamicId);
    }
    ...
    @Override
    public void setPresenter(SpecialFleaMarketContract.Presenter presenter) {
     ...
     * 表白墙的条目点击事件监听
     */
    private SpecialFleaMarketAdapter.OnSpecialConfessionItemClickListener
            onSpecialConfessionItemClickListener =
            new SpecialFleaMarketAdapter.OnSpecialConfessionItemClickListener() {
                @Override
