...
public class SearchDetailAllFragment extends BaseFragment implements
        SearchDetailContract.View, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {

    public static SearchDetailAllFragment newInstance() {
        Bundle args = new Bundle();
        SearchDetailAllFragment fragment = new SearchDetailAllFragment();
    ...
    public void onResume() {
        super.onResume();
        mPresenter.setSearchType(SearchDetailContract.Presenter.SEARCH_TYPE_ALL);
        mPresenter.start();
    }
