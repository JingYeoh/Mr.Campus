...
import com.jkb.core.presenter.function.special.function.SpecialLost$FoundPresenter;
import com.jkb.model.info.SchoolInfoSingleton;
import com.jkb.mrcampus.R;
import com.jkb.mrcampus.activity.MainActivity;
import com.jkb.mrcampus.adapter.recycler.special.function.SpecialLost$FoundAdapter;
...
public class SpecialLost$FoundFragment extends BaseFragment implements
        SpecialLostAndFoundContract.View, SwipeRefreshLayout.OnRefreshListener,
    ...
    private SpecialLostAndFoundContract.Presenter mPresenter;

    //列表
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private SpecialLost$FoundAdapter specialLost$FoundAdapter;
    ...
    protected void initListener() {
        ...
        specialLost$FoundAdapter.setOnSpecialConfessionItemClickListener(
    ...
    protected void initData(Bundle savedInstanceState) {
        //绑定P层
        mPresenter = new SpecialLost$FoundPresenter(this,
                Injection.provideSpecialRepertory(mActivity.getApplicationContext()));

        specialLost$FoundAdapter = new SpecialLost$FoundAdapter(context, null);
        recyclerView.setAdapter(specialLost$FoundAdapter);
    }
    ...
    public void setSpecialData(List<SpecialData> specialData) {
        specialLost$FoundAdapter.specialData = specialData;
        specialLost$FoundAdapter.notifyDataSetChanged();
    }

    @Override
    public void startSpecialLostAndFoundDetail(int dynamicId) {
        mainActivity.startSpecialDetailLostAndFound(dynamicId);
    }
    ...
    @Override
    public void setPresenter(SpecialLostAndFoundContract.Presenter presenter) {
     ...
     * 表白墙的条目点击事件监听
     */
    private SpecialLost$FoundAdapter.OnSpecialConfessionItemClickListener
            onSpecialConfessionItemClickListener =
            new SpecialLost$FoundAdapter.OnSpecialConfessionItemClickListener() {
                @Override
