...
public class SearchDetailSubjectFragment extends BaseFragment implements
        SearchDetailContract.View, SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {

    public static SearchDetailSubjectFragment newInstance() {
        Bundle args = new Bundle();
        SearchDetailSubjectFragment fragment = new SearchDetailSubjectFragment();
    ...
    public View onCreateView(
        ...
        setRootView(R.layout.frg_search_detail_subject);
    ...
    public void onResume() {
        super.onResume();
        mPresenter.setSearchType(SearchDetailContract.Presenter.SEARCH_TYPE_SUBJECT);
        mPresenter.start();
    }
