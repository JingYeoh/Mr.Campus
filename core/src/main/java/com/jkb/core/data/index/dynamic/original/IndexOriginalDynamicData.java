package com.jkb.core.data.index.dynamic.original;
...
public class IndexOriginalDynamicData extends IndexDynamicData {
    ...
    public IndexOriginalDynamicData() {
    }

    public IndexOriginalDynamicData(DynamicListEntity.DataBean.DynamicBean dynamicBean) {
        handleOriginalDynamicData(dynamicBean);
    }

    private IndexOriginalDynamicData INSTANCE = null;
    ...
    private void handleOriginalDynamicData(DynamicListEntity.DataBean.DynamicBean dynamicBean) {
        ...
        switch (dtype) {
            case "normal":
                INSTANCE = new IndexOriginalNormalDynamicData(dynamicBean.getContent().getNormal());
                break;
            case "topic":
                INSTANCE = new IndexOriginalTopicDynamicData(dynamicBean.getContent().getTopic());
                break;
            case "article":
                INSTANCE = new IndexOriginalArticleDynamicData(dynamicBean.getContent().getArticle());
                break;
            default:
                INSTANCE = null;
                break;
