...
public class IndexFavoriteDynamicData extends IndexDynamicData {
    ...
    private boolean isCircleDynamic;

    public IndexFavoriteDynamicData() {
    }

    public IndexFavoriteDynamicData(DynamicListEntity.DataBean.DynamicBean dynamicBean) {
        handleOriginalDynamicData(dynamicBean);
    }

    private IndexFavoriteDynamicData INSTANCE = null;
    ...
    private void handleOriginalDynamicData(DynamicListEntity.DataBean.DynamicBean dynamicBean) {
        ...
        switch (dtype) {
            case "normal":
                INSTANCE = new IndexFavoriteNormalDynamicData(dynamicBean.getContent().getNormal());
                break;
            case "topic":
                INSTANCE = new IndexFavoriteTopicDynamicData(dynamicBean.getContent().getTopic());
                break;
            case "article":
                INSTANCE = new IndexFavoriteArticleDynamicData(dynamicBean.getContent().getArticle());
                break;
            default:
                INSTANCE = null;
                break;
    ...
    private void bindGeneralOriginalDynamicData(DynamicListEntity.DataBean.DynamicBean dynamicBean) {
        ...
        //设置圈子
        DynamicListEntity.DataBean.DynamicBean.CircleBean circle = dynamicBean.getCircle();
        if (circle == null) {
            INSTANCE.setCircleDynamic(false);
            return;
        }
        INSTANCE.setCircleDynamic(true);
        ...
        circleInfo.setLongitude(circle.getLongitude());
        circleInfo.setLatitude(circle.getLatitude());
        INSTANCE.setCircle(circleInfo);
    }
    ...
    public boolean isCircleDynamic() {
        return isCircleDynamic;
    }

    public void setCircleDynamic(boolean circleDynamic) {
        isCircleDynamic = circleDynamic;
    }
