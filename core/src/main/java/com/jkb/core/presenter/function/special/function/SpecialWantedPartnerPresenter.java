...
public class SpecialWantedPartnerPresenter implements SpecialWantedPartnerContract.Presenter {

    private SpecialWantedPartnerContract.View view;
    ...
    public SpecialWantedPartnerPresenter(
            SpecialWantedPartnerContract.View view, SpecialRepertory repertory) {
        this.view = view;
    ...
    public void onItemClick(int position) {
        ...
        view.startSpecialWantedPartnerDetail(specialItemId);
    }
     ...
     * 请求表白墙专题数据
     */
    private void reqSpecialWantedPartnerData() {
        if (schoolId <= 0) {
            return;
        }
        LogUtils.d(SpecialWantedPartnerPresenter.class,"reqSpecialWantedPartnerData");
        String authorization = getAuthorization();
        repertory.getAllSpecialPartner(authorization, schoolId, pageControl.getCurrent_page(),
                specialCallback);
    }
