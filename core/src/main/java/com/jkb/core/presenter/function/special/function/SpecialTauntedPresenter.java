...
public class SpecialTauntedPresenter implements SpecialTauntedContract.Presenter {

    private SpecialTauntedContract.View view;
    ...
    public SpecialTauntedPresenter(
            SpecialTauntedContract.View view, SpecialRepertory repertory) {
        this.view = view;
    ...
    public void onItemClick(int position) {
        ...
        view.startSpecialTauntedDetail(specialItemId);
    }
     ...
     * 请求表白墙专题数据
     */
    private void reqSpecialTauntedData() {
        if (schoolId <= 0) {
            return;
        }
        String authorization = getAuthorization();
