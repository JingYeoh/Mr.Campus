...
public class SubjectDetailTauntedPresenter implements
        SubjectDetailTauntedContract.Presenter {

    private SubjectDetailTauntedContract.View view;
    ...
    public SubjectDetailTauntedPresenter(
            SubjectDetailTauntedContract.View view, SubjectDetailRepertory repertory) {
        this.view = view;
