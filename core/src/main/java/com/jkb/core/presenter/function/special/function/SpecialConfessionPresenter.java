...
public class SpecialConfessionPresenter implements SpecialConfessionContract.Presenter {

    private SpecialConfessionContract.View view;
    ...
    public SpecialConfessionPresenter(
            SpecialConfessionContract.View view, SpecialRepertory repertory) {
        this.view = view;
    ...
    public void onItemClick(int position) {
        ...
        view.startSpecialConfessionDetail(specialItemId);
    }
     ...
     * 请求表白墙专题数据
     */
    private void reqSpecialConfessionData() {
        if (schoolId <= 0) {
            return;
        }
        String authorization = getAuthorization();
        repertory.getAllSpecialConfession(authorization, schoolId, pageControl.getCurrent_page(),
                specialCallback);
    }
