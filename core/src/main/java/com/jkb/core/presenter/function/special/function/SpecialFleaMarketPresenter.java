...
public class SpecialFleaMarketPresenter implements SpecialFleaMarketContract.Presenter {

    private SpecialFleaMarketContract.View view;
    ...
    public SpecialFleaMarketPresenter(
            SpecialFleaMarketContract.View view, SpecialRepertory repertory) {
        this.view = view;
    ...
    public void onItemClick(int position) {
        ...
        view.startSpecialFleaMarketDetail(specialItemId);
    }
     ...
     * 请求表白墙专题数据
     */
    private void reqSpecialFleaMarketData() {
        if (schoolId <= 0) {
            return;
        }
        LogUtils.d(SpecialFleaMarketPresenter.class,"reqSpecialFleaMarketData");
        String authorization = getAuthorization();
        repertory.getAllSpecialFleaMarket(authorization, schoolId, pageControl.getCurrent_page(),
                specialCallback);
    }
