...
public class CircleAttentionUserListPresenter implements CircleAttentionUserListContract.Presenter {

    private CircleAttentionUserListContract.View view;
    ...
    public CircleAttentionUserListPresenter(
            CircleAttentionUserListContract.View view, CircleAttentionUserListRepertory repertory) {
        this.view = view;
    ...
    public void initCircleId() {
        ...
        isCircleCreator = view.isCircleCreator();
    }
    ...
    public void bindDataToView() {
        ...
        view.setUserData(usersInCircle, isCircleCreator);
    }
    ...
    public void onRefresh() {
        ...
        repertory.getUsersInCircle(Authorization, circle_id,
