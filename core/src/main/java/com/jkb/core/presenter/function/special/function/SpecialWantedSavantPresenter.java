...
public class SpecialWantedSavantPresenter implements SpecialWantedSavantContract.Presenter {

    private SpecialWantedSavantContract.View view;
    ...
    public SpecialWantedSavantPresenter(
            SpecialWantedSavantContract.View view, SpecialRepertory repertory) {
        this.view = view;
    ...
    public void onItemClick(int position) {
        ...
        view.startSpecialWantedSavantDetail(specialItemId);
    }
     ...
     * 请求表白墙专题数据
     */
    private void reqSpecialWantedSavantData() {
        if (schoolId <= 0) {
            return;
        }
        LogUtils.d(SpecialWantedSavantPresenter.class, "reqSpecialWantedSavantData");
        String authorization = getAuthorization();
        repertory.getAllSpecialGrind(authorization, schoolId, pageControl.getCurrent_page(),
                specialCallback);
    }
