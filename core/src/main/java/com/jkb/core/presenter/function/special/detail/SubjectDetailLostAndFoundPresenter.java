...
public class SubjectDetailLostAndFoundPresenter implements
        SubjectDetailLostAndFoundContract.Presenter {

    private SubjectDetailLostAndFoundContract.View view;
    ...
    public SubjectDetailLostAndFoundPresenter(
            SubjectDetailLostAndFoundContract.View view, SubjectDetailRepertory repertory) {
        this.view = view;
    ...
    public void bindDataToView() {
        ...
        view.dismissLoading();
        view.setLostAndFoundTitle(mConfessionData.getSubjectTitle());
        view.setLostAndFoundContent(mConfessionData.getSubjectText());
        view.setLostAndFoundImageUrls(mConfessionData.getImageUlrs());
        //设置个人数据
    ...
    @Override
    public void initConfessionData() {
        if (isCached) {
            bindDataToView();
        } else {
            onRefresh();
