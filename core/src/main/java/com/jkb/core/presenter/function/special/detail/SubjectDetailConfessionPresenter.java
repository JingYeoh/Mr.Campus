...
public class SubjectDetailConfessionPresenter implements SubjectDetailConfessionContract.Presenter {

    private SubjectDetailConfessionContract.View view;
    ...
    public SubjectDetailConfessionPresenter(
            SubjectDetailConfessionContract.View view, SubjectDetailRepertory repertory) {
        this.view = view;
    ...
    public void bindDataToView() {
        ...
        view.dismissLoading();
        view.setConfessionTitle(mConfessionData.getSubjectTitle());
        view.setConfessionContent(mConfessionData.getSubjectText());
        view.setConfessionImageUrls(mConfessionData.getImageUlrs());
        //设置个人数据
