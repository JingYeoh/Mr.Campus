package com.jkb.core.contract.function.special.detail.cofession;
...
public interface SubjectDetailConfessionContract {
    ...
    interface View extends BaseView<Presenter>, CommentContract.View {
         ...
         * 设置告白标题
         */
        void setConfessionTitle(String confessionTitle);

        /**
         * 设置告白主体
         */
        void setConfessionContent(String confessionContent);

        /**
         * 设置告白图片
         */
        void setConfessionImageUrls(List<String> confessionImageUrls);
